...
module.exports = app => {
    ...
    router.get('/alreadyEvaluated', controller.userOperation.alreadyEvaluated);     // 查询已评价的商品商品列表
    router.get('/tobeEvaluated', controller.userOperation.tobeEvaluated);     // 查询待评价的商品商品列表
    router.post('/evaluateOne',controller.userOperation.evaluateOne)             // 查询单条评价
